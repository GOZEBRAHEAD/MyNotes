...
namespace MyList
{
    public partial class FormSeeFavoriteNotes : Form
    {
        ...
        {
            totalNotes = DB_Data.GetTotalFavoriteNotes(Properties.Settings.Default.UserID);
        ...
        public void showFavoriteNotesByPage(int pageNumber)
        {
            // Obtain data + show it in the datagridview.
            DataSet ds = DB_Data.LoadFavoriteNotesByPage(Properties.Settings.Default.UserID, pageNumber);
            dt = ds.Tables[0];
        ...
        {
            DataSet ds_aux = DB_Data.GetAllFavoriteNotes(Properties.Settings.Default.UserID);
        ...
        {
            Form form;
            form = panelFAVOURITENOTES.Controls.OfType<MyForm>().FirstOrDefault();
            ...
            panelFAVOURITENOTES.Controls.Add(form);
            panelFAVOURITENOTES.Tag = form;
        ...
        private void FormSeeFavoriteNotes_Load(object sender, EventArgs e)
        {
            try
            {
                updateFavoriteNotes();
        ...
        private void textboxACTUAL_PAGE_TextChanged(object sender, EventArgs e)
        {
            ...
            if (textboxACTUAL_PAGE.Text != "")
            {
                ...
                if (pageWrited > maxPages || pageWrited <= 0)
                {
                    ...
                    actualPage = 1;
                    textboxACTUAL_PAGE.Text = "1";
                    showFavoriteNotesByPage(actualPage);
                }
